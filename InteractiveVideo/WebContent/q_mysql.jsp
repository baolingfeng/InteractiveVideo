...
<div class="qdiv w3-padding-jumbo disable-text">
    ...
    <span style="padding-left:20px"><input class="underline-input w3-light-grey " name="q1" size="60"></input></span>
    <br/><br/>
...
<div class="qdiv w3-padding-jumbo disable-text">
	...
	<div class="radio">
		<label class="w3-large"><input name="q2" id="1" value="1" type="checkbox"> Statement stmt = new Statement();</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q2" id="2" value="2" type="checkbox"> Statement stmt = new Statement(sql);</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q2" id="3" value="3" type="checkbox"> Statement stmt = conn.createStatement();</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q2" id="4" value="4" type="checkbox"> Statement stmt = conn.createStatement(sql);</label>
	</div>
</div>
...
<div class="qdiv w3-padding-jumbo disable-text">
	...
	<div class="radio">
		<label class="w3-large"><input name="q3" id="1" value="1" type="checkbox"> while(rs.hasNext()) {...}</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q3" id="2" value="2" type="checkbox"> while(rs.next()) {...}</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q3" id="3" value="3" type="checkbox"> while(rs != null) {rs.getNext();}</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q3" id="4" value="4" type="checkbox"> while(rs != null) {rs.next();}</label>
	</div>
</div>
...
<div class="qdiv w3-padding-jumbo disable-text">
	...
	<input class="underline-input w3-light-grey " name="q5" size="60"></input>
...
<div class="qdiv w3-padding-jumbo disable-text">
	...
	<div class="radio">
		<label class="w3-large"><input name="q6" id="1" value="1" type="checkbox"> int autoid = stmt.executeUpdate(sql); </label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q6" id="2" value="2" type="checkbox"> Resultset rs = stmt.executeUpdate(sql); int autoid = rs.getInt(1);</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q6" id="3" value="3" type="checkbox"> Resultset rs = stmt.executeUpdate(sql); int autoid = rs.getGeneratedKeys();</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q6" id="4" value="4" type="checkbox"> Resultset rs = stmt.executeQuery(sql); int autoid = rs.getGeneratedKeys();</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q6" id="5" value="5" type="checkbox"> stmt.executeUpdate(sql); Resultset rs = stmt.getGeneratedKeys(); int autoid = rs.getInt(1);</label>
	</div>
	<div class="radio">
		<label class="w3-large"><input name="q6" id="6" value="6" type="checkbox"> stmt.executeQuery(sql); Resultset rs = stmt.getGeneratedKeys(); int autoid = rs.getInt(1);</label>
	</div>
</div>
...
<div class="qdiv w3-padding-jumbo disable-text">
	...
	<input class="underline-input w3-light-grey " name="q7" />次有输出结果， 结果分别是
	<input class="underline-input w3-light-grey " name="q7" />。
...
<div class="qdiv w3-padding-jumbo disable-text">
	...
	<input class="underline-input w3-light-grey " name="q8" />，运行结果:
	<input class="underline-input w3-light-grey " name="q8" />
